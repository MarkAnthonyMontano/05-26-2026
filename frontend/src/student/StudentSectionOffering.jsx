  ...
  <Box sx={{
    ...
    <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", mb: 0.5 }}>
      ...
      <Box sx={{
        ...
        <Typography sx={{ fontSize: 10, color: "#444", fontWeight: 600, lineHeight: 1.2 }}>
...
const StudentCurriculumSubjects = () => {
  ...
  const headCell = {
    ...
    fontSize: 12, textTransform: "uppercase", border: `1px solid ${borderColor}`,
  };
  const colStyle = {
    border: `1px solid ${borderColor}`, fontSize: 13,
    wordWrap: "break-word", overflowWrap: "break-word", whiteSpace: "normal",
  };
  const bodyCell = { fontSize: 13, border: `1px solid ${borderColor}` };
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", mb: 3 }}>
        {programInfo && (
          <Typography variant="h4" sx={{
            ...
            fontSize: { xs: "16px", sm: "22px", md: "28px", lg: "32px" },
            lineHeight: 1.3,
          }}>
        ...
        return (
          <Box key={idx} sx={{ mb: 4 }}>
            ...
            <Box sx={{
              ...
              {/* Info — stacks on mobile, side-by-side on desktop */}
              <Box sx={{ flex: 1, minWidth: 0 }}>
                {programInfo && (
                  <Box sx={{
                    display: "flex",
