      ...
      <div style={S.card}>
        ...
        <div style={S.cardBody}>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <div style={S.profileBox(errors.profile_img)} onClick={() => setUploadModalOpen(true)}>
              {person.profile_img ? (
                <img
                ...
                <>
                  ...
                  <div style={{ fontSize: 11, color: errors.profile_img ? "#d32f2f" : "#888", textAlign: "center", padding: "0 8px" }}>
                    {errors.profile_img ? "Photo required" : "Tap to upload photo"}
                  </div>
                </>
              )}
            </div>
            ...
            <MSelect name="program" value={person.program || ""} onChange={handleChange} error={errors.program}>
              ...
              {filteredCurriculum.map((item, i) => (
                <option key={i} value={item.curriculum_id}>
                  ...
                  {item.major ? ` (${item.major})` : ""} ({item.current_year}-{item.next_year}) ({getBranchLabel(item.components)})
                </option>
              ))}
            </MSelect>
          </Field>
      ...
      <div style={S.card}>
        ...
        <div style={S.cardBody}>
            ...
            <label style={{ ...S.checkRow, marginTop: 6 }}>
              <input
                ...
                onChange={(e) => {
                  ...
                  const updated = { ...person, lrnNumber: checked ? "No LRN Number" : "" };
                  setPerson(updated);
                  setIsLrnNA(checked);
          ...
          <label style={S.checkRow}>
            <input type="checkbox" style={S.checkbox} checked={person.pwdMember === 1} onChange={(e) => { const checked = e.target.checked; const updated = { ...person, pwdMember: checked ? 1 : 0, pwdType: checked ? person.pwdType || "" : "", pwdId: checked ? person.pwdId || "" : "" }; setPerson(updated); handleUpdate(updated); }} />
      ...
      <div style={S.card}>
        ...
        <div style={S.cardBody}>
          ...
          <Field label="Region" required error={errors.presentRegion} helperText="This field is required.">
            <MSelect name="presentRegion" value={person.presentRegion || ""} onChange={(e) => { handleChange(e); setProvinceList([]); setCityList([]); setBarangayList([]); }} error={errors.presentRegion}>
          ...
          <Field label="Province" required error={errors.presentProvince} helperText="This field is required.">
            <MSelect name="presentProvince" value={person.presentProvince || ""} onChange={(e) => { handleChange(e); setCityList([]); setBarangayList([]); }} disabled={!person.presentRegion} error={errors.presentProvince}>
          ...
          <Field label="Municipality / City" required error={errors.presentMunicipality} helperText="This field is required.">
            <MSelect name="presentMunicipality" value={person.presentMunicipality || ""} onChange={(e) => { handleChange(e); setBarangayList([]); }} disabled={!person.presentProvince} error={errors.presentMunicipality}>
          ...
          <Field label="Barangay" required error={errors.presentBarangay} helperText="This field is required.">
            <MSelect name="presentBarangay" value={person.presentBarangay || ""} onChange={handleChange} disabled={!person.presentMunicipality} error={errors.presentBarangay}>
