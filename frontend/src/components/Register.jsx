...
const Register = () => {
  ...
  const handleRegister = async () => {
    ...
    try {
      await axios.post(`${API_BASE_URL}/auth/request-otp`, { email: usersData.email, audit_log_db: "db" });
  ...
  const resendOtp = async () => {
    try {
      setLoadingOtp(true);
      await axios.post(`${API_BASE_URL}/auth/request-otp`, { email: tempEmail, audit_log_db: "db" });
      startResendTimer();
  ...
  const verifyOtp = async () => {
    ...
    try {
      const response = await axios.post(`${API_BASE_URL}/auth/register`, {
        ...usersData, campus: branchId, lastName, firstName, middleName, birthday,
