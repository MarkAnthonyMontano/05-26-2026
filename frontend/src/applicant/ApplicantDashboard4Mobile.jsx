...
// ─── Main Component ───────────────────────────────────────────────────────────
const ApplicantDashboard4Mobile = (props) => {
      ...
      <div style={{ ...S.card, marginBottom: 16, border: `1px solid ${borderColor}`, }}>
        ...
        >
          <Button
            ...
            onClick={() => {
              showSnackbar("Your record has been saved successfully!", "success");
              setTimeout(() => navigate(`/dashboard/${keys.step3}`), 1000);
            }}
            startIcon={
              <ArrowBackIcon
          ...
          <Button
            ...
            onClick={() => {
              handleUpdate(person);
              showSnackbar("Your record has been saved successfully!", "success");
              setTimeout(() => navigate(`/dashboard/${keys.step5}`), 1000);
            }}
            endIcon={
              <ArrowForwardIcon
...
export default ApplicantDashboard4Mobile;
